...
#ifndef dam_break_high_res_h
#define dam_break_high_res_h
class dam_break_high_res:public file_load
{
public:
    dam_break_high_res()
    {
#ifdef __APPLE__
        m_data_path = "../Large_data/DamBreak3D/my_format_highres2/iter_";
#else
        m_data_path = "../../Large_data/DamBreak3D/my_format_highres2/iter_";
#endif
        load_time_step();
